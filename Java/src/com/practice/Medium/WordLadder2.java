...
public class WordLadder2 {
    ...
    /**
     *  is the ladder existent, from beginWord to endWord?
     *
     * @param beginWord
     * @param endWord
     * @param wordList
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        // hashset for efficient deletion in BFS
        // build up adjList
        ...
        // traverse the DAG (here, the adjList) to find all the paths between endWord and beginWord
