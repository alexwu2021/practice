 ...
 * s that exist in dict. If two such substrings overlap, you need to wrap them together by only one pair of closed bold tag. Also,
...
public class AddBoldTags {
    ...
    /** ------------------------------------------------------------------------
     * Originally from shawngo,
     * The idea is to construct a guiding array
     *
     * @param s
     * @param dict
     * @return
