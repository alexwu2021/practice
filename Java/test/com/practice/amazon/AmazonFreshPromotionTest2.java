...
//
//    @Test
//    public void checkIfIsAWinner() {
//        AmazonFreshPromotion amazonFreshPromotion = new AmazonFreshPromotion();
//        List<java.util.List<String>>codeList = new ArrayList<>();
//        List<String>shoppingCart;
//        codeList.add(Arrays.asList(new String[]{"apple", "apple"}));
//        codeList.add(Arrays.asList(new String[]{"banana","anything", "banana"}));
//
//        shoppingCart = Arrays.asList(new String[]{"orange","apple", "apple", "banana","orange", "banana"});
//        int actual =   amazonFreshPromotion.checkIfIsAWinner(codeList, shoppingCart);
//        int expected = 1;
//        Assert.assertEquals(expected, actual);
//
//        // shoppingCart.clear(); // this is unsupported in Java
//
//        shoppingCart = Arrays.asList(new String[]{"banana","orange", "banana","apple", "banana"});
//        actual =   amazonFreshPromotion.checkIfIsAWinner(codeList, shoppingCart);
//        expected = 0;
//        Assert.assertEquals(expected, actual);
//
//        shoppingCart = Arrays.asList(new String[]{"apple","banana", "apple", "banana","orange", "banana"});
//        actual =   amazonFreshPromotion.checkIfIsAWinner(codeList, shoppingCart);
//        expected = 0;
//        Assert.assertEquals(expected, actual);
//
//        shoppingCart=Arrays.asList(new String[]{"apple", "apple", "apple", "banana"});
//        actual =   amazonFreshPromotion.checkIfIsAWinner(codeList, shoppingCart);
//        expected = 0;
//        Assert.assertEquals(expected, actual);
//    }
