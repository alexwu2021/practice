...
public class AddBoldTagsTest {
    private AddBoldTags addBoldTags = new AddBoldTags();
    @Test
    public void addBoldTag() {
        ...
        input = "aaabbcc";
        dict = new String[]{"aaabbcc"};

        actual = addBoldTags.addBoldTag(input, dict);
